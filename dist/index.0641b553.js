...
const UIController = function() {
    //object to hold ref to html selectors
    const DOMElements = {
    ...
    return {
        ...
        createSongDetail (img, title, artist) {
            ...
            // clear song details when clicking other song
            detailDiv.innerHTML = "";
            const html = `
...
const APPController = function(UICtrl, APICtrl) {
    ...
    DOMInputs.genre.addEventListener("change", async ()=>{
        // when user changes genres, we need to reset the subsequent field
        ...
        //get the playlist data from spotify based in the genre
        const playlist = await APICtrl.getPlayListByGenre(token, genreId);
        // load the playlist
        console.log(playlist);
    });
    //create submit button click event change event listener
